...
```bash
git clone https://github.com/fanitriastowo/phaser3-typescript-template.git my-folder-name
```

Go into your new project folder and install dependencies:

```bash
cd my-folder-name # or 'my-folder-name'
yarn
```
...
```
./node_modules/.bin/parcel src/index.html -p 3000
```
